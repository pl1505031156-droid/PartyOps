...
FILES=(
  "PartyOps_1.4.5-rc.4_windows_amd64.exe"
  "PartyOps_1.4.5-rc.4_windows7_amd64.exe"
  "PartyOps_1.4.5-rc.4_windows7_x86.exe"
  "PartyOps_1.4.5-rc.4_linux_amd64.deb"
  "PartyOps_1.4.5-rc.4_linux_arm64.deb"
  "PartyOps-1.4.5-0.rc.4.1.x86_64.rpm"
  "PartyOps-1.4.5-0.rc.4.1.aarch64.rpm"
)
...
manifest = {
    ...
    "platform_artifacts": {
        ...
        "windows7": {
            "amd64": "PartyOps_1.4.5-rc.4_windows7_amd64.exe",
            "x86": "PartyOps_1.4.5-rc.4_windows7_x86.exe",
        },
        "linux-deb": {
            "amd64": "PartyOps_1.4.5-rc.4_linux_amd64.deb",
            "arm64": "PartyOps_1.4.5-rc.4_linux_arm64.deb",
        },
        "linux-rpm": {
            "amd64": "PartyOps-1.4.5-0.rc.4.1.x86_64.rpm",
            "arm64": "PartyOps-1.4.5-0.rc.4.1.aarch64.rpm",
        },
    },
    "artifacts": artifacts,
    "release_notes": [
...
(root / "RELEASE-NOTES.txt").write_text(
    "党建智办 PartyOps 1.4.5-rc.4 原位更新包\n"
