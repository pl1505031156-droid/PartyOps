...
DEB_VERSION="1.4.5~rc.3"
RPM_VERSION="1.4.5"
RPM_RELEASE="0.rc.3.1"
...
EOF
  ...
  OUTPUT="$ARTIFACTS/PartyOps_1.4.5-rc.3_linux_${ARCH}.deb"
...
EOF
  ...
  rpmbuild \
    ...
    -bb "$BUILD/rpmbuild/SPECS/partyops.spec"
  OUTPUT="$ARTIFACTS/PartyOps-1.4.5-0.rc.3.1.${RPM_ARCH}.rpm"
