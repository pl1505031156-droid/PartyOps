...
def test_artifact_selection_rejects_manifest_zip_mismatches(
    ...
    package = tmp_path / "release.partyops-update"
    artifact_name = "PartyOps_1.4.3-rc.8_linux_amd64.deb"
    ...
    for manifest, architecture, platform_name, message in (
        (
            {"version": "1.4.3-rc.8", "platform_artifacts": []},
            "amd64",
            "linux-deb",
            "不包含",
        ),
    ...
    bridge["version"] = "1.4.3-rc.8"
    bridge["min_version"] = "1.4.3-rc.8"
    ...
    invalid_minimum["min_version"] = "1.4.3-rc.9"
